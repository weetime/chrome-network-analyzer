...
async function sendToAnthropic(
  ...
  try {
    // 选择模型
    const modelId =
      AI_PROVIDERS.ANTHROPIC.models[model] ||
      AI_PROVIDERS.ANTHROPIC.models[AI_PROVIDERS.ANTHROPIC.defaultModel];
    ...
    // 构建请求体
    const requestBody = AI_PROVIDERS.ANTHROPIC.buildRequest(
      modelId,
      systemPrompt,
      userContent,
      maxTokens
